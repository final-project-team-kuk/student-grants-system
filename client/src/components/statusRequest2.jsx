...
//   useEffect(() => {
//   // במקום לפנות לשרת, אנחנו מדמים תשובה שחוזרת מה-DB
//   const simulateFetch = () => {
//     setTimeout(() => {
//       const mockResponse = {
//         status: "rejected", // תוכלי לשנות כאן ל-"approved" או "rejected" כדי לבדוק את כל העיצובים שלך!
  ...
  useEffect(() => {
    const fetchStatus = async () => {
      try {
        ...
        const response = await fetch("http://localhost:5000/api/requests/status/66a111111111111111111111", {
          // method: "GET",
          // headers: {
          //   "Content-Type": "application/json",
          //   "Authorization": `Bearer ${token}` // ודאי שזה תואם לפורמט ה-Middleware שלך
          // }
        });
